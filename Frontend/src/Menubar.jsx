...
const Menubar = ({ subMenu, setSubmenu, handleActiveMenu, loggedIn, onLogout }) => {
        ...
        <div className="flex gap-2.25">
          ...
          {loggedIn && (
            <div className="flex gap-2">
              <Link
                to={"/dashboard"}
                className="bg-[#0350f5] flex items-center justify-center hover:opacity-50 px-4 h-10 rounded-[25px] cursor-pointer text-white whitespace-nowrap text-sm"
              >
                Dashboard
              </Link>
              <button
                ...
                className="bg-red-600 hover:bg-red-700 flex items-center justify-center px-4 h-10 rounded-[25px] cursor-pointer text-white whitespace-nowrap text-sm"
              >
                Logout
              </button>
            </div>
